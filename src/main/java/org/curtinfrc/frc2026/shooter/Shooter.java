...
public class Shooter extends SubsystemBase {
  ...
  private static final double RECOVERY_BOOST_VOLTS = 3;
  private static final double SHOT_LOAD_BOOST_VOLTS = 2.25;
  ...
  private static final double FLYWHEEL_KP_VOLTS_PER_RPS = 0.084;
  ...
  static {
    ...
    FLYWHEEL_RPM_BY_DISTANCE.put(1.00, 1075.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(1.50, 1075.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(2.00, 3000.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(2.50, 2085.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(3.00, 2300.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(3.50, 2475.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(4.00, 2650.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(4.50, 2750.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(5.00, 2850.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(5.50, 2950.0);
    FLYWHEEL_RPM_BY_DISTANCE.put(6.00, 3025.0);
  ...
  public Command shootingCommand() {
    return run(
        () -> {
          flywheelMotor.setVoltage(7.5);
          feederMotor.setVoltage(7.5);
        });
  }

  public Command shootingstopCommand() {
    return run(
        () -> {
