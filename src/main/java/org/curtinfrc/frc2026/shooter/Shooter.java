...
public class Shooter extends SubsystemBase {
  ...
  public Command shoot(DoubleSupplier distanceSupplier) {
    return createShootCommand(distanceSupplier, null, 0).withName("Shoot Continuously");
  }
  ...
  public Command shootBurst(DoubleSupplier distanceSupplier, int feedPulses) {
    ...
    return createShootCommand(distanceSupplier, null, feedPulses)
  ...
  public Command testShootAtRpm(double targetRpm) {
    ...
    return createShootCommand(null, () -> targetRpm, 0)
  ...
  private Command createShootCommand(
      DoubleSupplier distanceSupplier, DoubleSupplier fixedRpmSupplier, int requestedPulses) {
