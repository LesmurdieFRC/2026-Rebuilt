...
public class TunerConstants {
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  // Conservative starting point for reducing four-module acceleration brownouts.
                  // Tune from PDH and drivetrain logs on the real robot.
  ...
  public static final CANBus kCANBus = new CANBus("Swerve Drivebase", "./logs/example.hoot");
